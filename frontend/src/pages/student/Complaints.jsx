...
export default function Complaints() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      <div className="p-4 rounded-2xl bg-white border border-brand-border/80 shadow-xs flex flex-col md:flex-row gap-3">
        {/* Search */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {complaints.map((item) => (
            <Link
              ...
              className="p-5 rounded-2xl bg-white border border-brand-border/80 hover:border-brand-teal/40 hover:shadow-card-hover transition-all flex flex-col justify-between group"
            >
              <div className="space-y-3">
                ...
                <div>
                  <h3 className="font-heading font-bold text-base text-brand-dark group-hover:text-brand-teal transition-colors">
                    {item.title}
                  </h3>
